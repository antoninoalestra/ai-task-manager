        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-3 rounded-xl bg-slate-100/80 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-xs min-h-[44px] font-medium"
            />
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full min-h-[44px] px-3.5 py-2.5 rounded-xl bg-slate-100/80 border border-slate-200 text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-xs font-mono font-medium"
                />
              </div>
            ...
            <div className="flex items-center gap-1.5 pt-1 overflow-x-auto no-scrollbar">
              ...
              {[
                ...
                <button
                  ...
                  className="min-h-[36px] px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 border border-slate-200 text-[11px] font-bold transition-all shrink-0 active:scale-95"
                >
                  {p.label}
                </button>
              ))}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-100/80 border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-xs font-medium"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-200 mt-4 pb-safe">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="min-h-[44px] px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold disabled:opacity-50 text-xs transition-all shadow-md shadow-blue-600/20 flex items-center gap-1.5 active:scale-95"
              >
                {isSubmitting ? (
                  <>
