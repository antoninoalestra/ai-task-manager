    ...
    <nav className="fixed bottom-3 inset-x-3 z-40 max-w-md mx-auto lg:hidden pointer-events-none pb-safe">
      <div className="pointer-events-auto flex items-center justify-around h-14 px-3 rounded-full bg-white/90 backdrop-blur-xl border border-slate-200 shadow-xl shadow-slate-900/10">
        ...
        <button
          ...
          className="flex items-center justify-center min-w-[44px] min-h-[44px] w-11 h-11 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg shadow-indigo-600/30 active:scale-95 transition-all touch-manipulation border border-white/20"
        >
        ...
        >
          ...
          {todoCount > 0 && (
            <span className="px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-indigo-100 text-indigo-800 border border-indigo-200 tabular-nums">
              {todoCount}
            </span>
          )}
        </button>
