...
/**
 * Legge tutti i task ed eventi dal database per un determinato utente
 */
export async function getEventsAndTasks(userId = 'default_user') {
...
/**
 * Salva un nuovo evento o task vincolato all'utente autenticato
 */
export async function saveTaskOrEvent(item, userId = 'default_user') {
...
/**
 * Aggiorna lo stato di completamento di un task per l'utente loggato
 */
export async function toggleTaskCompletion(id, isCompleted, userId = 'default_user') {
  let query = supabaseAdmin
    .from('events_and_tasks')
...
/**
 * Aggiorna tutti i campi di un evento o task dell'utente loggato
 */
export async function updateTaskOrEvent(id, updates, userId = 'default_user') {
  const payload = {
    title: updates.title,
...
/**
 * Elimina un evento o task dell'utente loggato dal database
 */
export async function deleteTaskOrEvent(id, userId = 'default_user') {
  let query = supabaseAdmin
    .from('events_and_tasks')
    .delete()
    .eq('id', id);
