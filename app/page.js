...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-slate-900 p-2 sm:p-4 lg:p-6 pb-24 lg:pb-6 font-sans selection:bg-blue-100 selection:text-blue-900">
      {/* TOAST SYSTEM NON-BLOCCANTE LIGHT THEME */}
      {toast && (
      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-5 min-h-[92vh]">
        ...
        {/* SIDEBAR SINISTRA DESKTOP (LIGHT SURFACE #ffffff) */}
        <aside className="hidden lg:flex lg:col-span-3 flex-col bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-6">
          {/* Header Brand */}
          ...
          <button
            ...
            className="w-full min-h-[44px] px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs transition-all shadow-md shadow-blue-600/20 flex items-center justify-center gap-2 active:scale-95 touch-manipulation"
          >
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <span className="text-[10px] font-mono bg-slate-100 px-2 py-0.5 rounded-full font-bold">
                  {items.length}
                </span>
              </button>
                  ...
                  return (
                    <div
                      ...
                      className={`group flex items-center justify-between p-2.5 rounded-xl border transition-all ${cat.bg} ${cat.border} ${
                        todo.is_completed ? 'opacity-40' : 'hover:shadow-sm'
                      }`}
                    >
        ...
        <section className="lg:col-span-9 flex flex-col space-y-5">
          ...
          <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border border-slate-200 rounded-2xl shadow-sm">
          ...
          {activeTab === 'calendar' ? (
            ...
            <section className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-6 shadow-sm space-y-4 max-w-4xl mx-auto flex-1 w-full">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all flex items-center gap-1 shadow-md shadow-blue-600/20 active:scale-95 touch-manipulation"
                >
                        ...
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <span className={`w-1.5 h-1.5 rounded-full ${cat.dot}`}></span>
                              <span className={`text-[10px] capitalize font-bold ${cat.text}`}>
                                {cat.label}
                              </span>
                            </div>
                          </div>
