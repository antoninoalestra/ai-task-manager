...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f1f3f7] text-slate-900 p-2 sm:p-4 lg:p-6 pb-24 lg:pb-6 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      {/* TOAST SYSTEM NON-BLOCCANTE SOFT LIGHT */}
      {toast && (
        <div className="fixed top-4 right-4 z-[10000] flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-900/10 text-xs font-bold animate-slide-up-sheet text-slate-900">
      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-5 min-h-[92vh]">
        ...
        {/* SIDEBAR SINISTRA DESKTOP (LIGHT SURFACE #f8fafc) */}
        <aside className="hidden lg:flex lg:col-span-3 flex-col bg-[#f8fafc] border border-slate-200 rounded-2xl p-5 shadow-xs space-y-6">
          {/* Header Brand */}
          <div className="flex items-center justify-between border-b border-slate-200/80 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-sm font-bold tracking-tight text-slate-900">AI Task Manager</h1>
                <p className="text-[10px] text-slate-500 font-mono font-medium">Personal Workspace</p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full min-h-[44px] px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs transition-all shadow-md shadow-indigo-600/20 flex items-center justify-center gap-2 active:scale-95 touch-manipulation"
          >
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <span className="text-[10px] font-mono bg-slate-200/80 px-2 py-0.5 rounded-full font-bold text-slate-700">
                  {items.length}
                </span>
              </button>
          ...
          <div className="flex-1 flex flex-col min-h-0 pt-2 border-t border-slate-200/80">
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-slate-400 hover:text-rose-600 p-1 transition-colors opacity-0 group-hover:opacity-100"
                        title="Elimina"
                      >
        ...
        <section className="lg:col-span-9 flex flex-col space-y-5">
          ...
          <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border border-slate-200 rounded-2xl shadow-xs">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-bold text-slate-900 tracking-tight">AI Task Manager</span>
            </div>
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[10px] font-bold border whitespace-nowrap shrink-0 transition-all ${
                  selectedCategoryFilter === key
                    ? 'bg-indigo-600 text-white border-indigo-600 shadow-sm'
                    : `bg-white border-slate-200 ${cat.text}`
                }`}
              >
          ...
          {activeTab === 'calendar' ? (
            ...
            <section className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-6 shadow-xs space-y-4 max-w-4xl mx-auto flex-1 w-full">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all flex items-center gap-1 shadow-md shadow-indigo-600/20 active:scale-95 touch-manipulation"
                >
              ...
              {todos.length === 0 ? (
                <div className="py-16 text-center text-slate-400 text-xs italic space-y-2 font-medium">
                  <CheckSquare className="w-8 h-8 mx-auto text-slate-300 stroke-[1.5]" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={() => handleDeleteTask(todo.id)}
                          className="min-w-[36px] min-h-[36px] flex items-center justify-center text-slate-400 hover:text-rose-600 transition-colors active:scale-95 touch-manipulation"
