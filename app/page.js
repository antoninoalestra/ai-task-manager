...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#16181d] text-slate-100 p-2 sm:p-4 lg:p-6 pb-24 lg:pb-6 font-sans selection:bg-indigo-900 selection:text-white">
      {/* TOAST SYSTEM NON-BLOCCANTE SOFT DARK */}
      {toast && (
        <div className="fixed top-4 right-4 z-[10000] flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-[#232730] border border-white/[0.1] shadow-2xl text-xs font-semibold animate-slide-up-sheet text-white">
      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-5 min-h-[92vh]">
        ...
        {/* SIDEBAR SINISTRA DESKTOP (SURFACE SUBTLE #1d2026) */}
        <aside className="hidden lg:flex lg:col-span-3 flex-col bg-[#1d2026] border border-white/[0.08] rounded-2xl p-5 shadow-xl space-y-6">
          {/* Header Brand */}
          ...
          <button
            ...
            className="w-full min-h-[44px] px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs transition-all shadow-md shadow-indigo-600/20 flex items-center justify-center gap-2 active:scale-95 touch-manipulation"
          >
                        ...
                        <div className="min-w-0 flex-1">
                          <p
                            className={`font-semibold text-xs truncate ${
                              todo.is_completed ? 'line-through text-slate-400' : 'text-slate-100'
                            }`}
                          >
                            {todo.title}
                          </p>
        ...
        <section className="lg:col-span-9 flex flex-col space-y-5">
          ...
          <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-[#1d2026] border border-white/[0.08] rounded-2xl shadow-xl">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-bold shadow-md shadow-indigo-600/25">
            ...
            <div className="flex items-center p-1 rounded-xl bg-[#191c22] border border-white/[0.06]">
              <button
                type="button"
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-xl text-[10px] font-bold border whitespace-nowrap shrink-0 transition-all ${
                selectedCategoryFilter === 'all'
                  ...
                  : 'bg-[#232730] border-white/[0.08] text-slate-400'
              }`}
            >
              Tutte ({items.length})
            </button>
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[10px] font-medium border whitespace-nowrap shrink-0 transition-all ${
                  selectedCategoryFilter === key
                    ...
                    : `bg-[#232730] border-white/[0.08] ${cat.text}`
                }`}
              >
          ...
          {activeTab === 'calendar' ? (
            ...
            <section className="bg-[#232730] border border-white/[0.08] rounded-2xl p-4 sm:p-6 shadow-2xl space-y-4 max-w-4xl mx-auto flex-1 w-full">
              <div className="flex items-center justify-between border-b border-white/[0.06] pb-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-all flex items-center gap-1 shadow-md shadow-indigo-600/25 active:scale-95 touch-manipulation"
                >
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center justify-between p-3.5 rounded-2xl border transition-all ${cat.bg} ${cat.border} ${
                          todo.is_completed ? 'opacity-40' : 'hover:border-slate-400 shadow-md'
                        }`}
                      >
